...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_zzjqo5i", // your Service ID
        "template_yxdm55n", // your Template ID
        {
          from_name: form.name,
          to_name: "Ahmed Ghazanfar",
          from_email: form.email,
          to_email: "ahmedghazanfar1@gmail.com",
          message: form.message,
          sent_at: new Date().toLocaleString(),
        },
        "ohrMekhG2jeknR44s" // your Public Key
      )
      .then(
        () => {
          setLoading(false);
